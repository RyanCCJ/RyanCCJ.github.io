...
<img src="/static/images/2025/deep-learning-basic/ch2/cover.jpg" style={{margin:'auto'}}/>
<center><small>電腦視覺有豐富的應用：物件偵測、文字辨識、醫療檢測、圖像分割等</small></center>
...
例如 Google DeepMind 發表的 [AlphaFold](https://deepmind.google/science/alphafold/) [^26]，就是將胺基酸之間的距離和接觸可能性表示成矩陣，再搭配一些領域知識來預測蛋白質結構。
