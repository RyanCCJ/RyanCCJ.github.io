---
title: 'Coding Style and Performance'
date: '2022-07-06'
tags: ['Code','Python']
draft: false
summary: '實驗室教學文系列：如何寫好程式？包含 DRY、規格化、模組化、效能優化、驗證等幾個方向供參考'
---
> 以下轉自我之前的實驗室教學，原文連結請參考 [Github](https://github.com/RyanCCJ/2022_Lab_Training/blob/master/Lesson2_Python/Coding_Style_and_Performance.md)
...
![](/static/images/2022/coding-style-and-performance/graph.png)
...
- **Spaghetti Code**
<img src="/static/images/2022/coding-style-and-performance/spaghetti-code.png" width='600'/>
...
![](/static/images/2022/coding-style-and-performance/codon.jpg)
...
![](/static/images/2022/coding-style-and-performance/module.png)
...
![](/static/images/2022/coding-style-and-performance/list.png)

![](/static/images/2022/coding-style-and-performance/dataframe.png)
...
```
- 不同資料型態所佔的空間：
<img src="/static/images/2022/coding-style-and-performance/data-type.png" width='500'/>
...
<img src="/static/images/2022/coding-style-and-performance/big-O.jpg" width='600'/>
...
<img src="/static/images/2022/coding-style-and-performance/excel.jpg" width='500'/>
...
![](/static/images/2022/coding-style-and-performance/diff.png)

### 客製化測試
有時候，雖然兩邊資料不一致，但在邏輯上應該要視為一樣。

- [浮點數運算上的限制 IEEE-754](https://docs.python.org/zh-tw/3/tutorial/floatingpoint.html)
