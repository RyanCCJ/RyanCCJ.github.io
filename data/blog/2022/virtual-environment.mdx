---
title: '虛擬環境 Virtual Environment'
date: '2022-05-01'
tags: ['Code','Python']
draft: false
summary: '實驗室教學文系列：什麼是虛擬環境？有那麼重要嗎？這篇文章將告訴你如何從零開始建立 Python 虛擬環境'
---
> 以下轉自我之前的實驗室教學，原文連結請參考 [Github](https://github.com/RyanCCJ/2022_Lab_Training/blob/master/Lesson1_Linux/Virtual_Environment.md)

為什麼要建立虛擬環境？有那麼重要嗎？讓我們來看看以下案例：

- **案例一**：在你的電腦上開發專案  
假設今天你有習慣使用的公司電腦或個人筆電，且同時維護數個專案。  
專案 A 可能需要 Python 2.7，或是 Pandas、Matplotlib 等相關套件；專案 B 可能需要 Python 3.8 以及 Django 等其他套件；專案 C 可能需要 TensorFlow 或其他 ML 套件...  
...
$ python -m virtualenv "<YOUR VENV NAME>" #建立虛擬環境，以下假設是VENV
...
<img src='/static/images/2022/virtual-environment/Anaconda.png' width='400' />
